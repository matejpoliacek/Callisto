...
public class GStickSwitch extends LinearLayout {
    ...
    public GStickSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);

        mContext = context;

        mbitmap_on = BitmapFactory.decodeResource(getResources(), R.drawable.on_switch);
        mbitmap_off = BitmapFactory.decodeResource(getResources(), R.drawable.off_switch);
        ...
        inflater.inflate(R.layout.stick_switch, this, true);
    ...
    public GStickSwitch(Context context) {
        this(context, null);
    }
