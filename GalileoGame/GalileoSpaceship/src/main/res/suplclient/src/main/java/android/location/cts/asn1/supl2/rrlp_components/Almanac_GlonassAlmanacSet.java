...
public  class Almanac_GlonassAlmanacSet extends Asn1Sequence {
  ...
  private Almanac_GlonassAlmanacSet.gloAlmnAType_ gloAlmnA_;
  public Almanac_GlonassAlmanacSet.gloAlmnAType_ getGloAlmnA() {
    return gloAlmnA_;
  }
  /**
   * @throws ClassCastException if value is not a Almanac_GlonassAlmanacSet.gloAlmnAType_
   */
  public void setGloAlmnA(Asn1Object value) {
    this.gloAlmnA_ = (Almanac_GlonassAlmanacSet.gloAlmnAType_) value;
  }
  public Almanac_GlonassAlmanacSet.gloAlmnAType_ setGloAlmnAToNewInstance() {
    gloAlmnA_ = new Almanac_GlonassAlmanacSet.gloAlmnAType_();
    return gloAlmnA_;
  }
  ...
  @Override public Iterable<? extends SequenceComponent> getComponents() {
    ...
    builder.add(new SequenceComponent() {
          ...
          @Override public Collection<Asn1Tag> getPossibleFirstTags() {
            return tag == null ? Almanac_GlonassAlmanacSet.gloAlmnAType_.getPossibleFirstTags() : ImmutableList.of(tag);
          }
...
/**
 */
public static class gloAlmnAType_ extends Asn1Integer {
  //

  private static final Asn1Tag TAG_gloAlmnAType_
      = Asn1Tag.fromClassAndNumber(-1, -1);

  public gloAlmnAType_() {
    super();
    setValueRange("1", "24");
  ...
  public static Collection<Asn1Tag> getPossibleFirstTags() {
    if (TAG_gloAlmnAType_ != null) {
      return ImmutableList.of(TAG_gloAlmnAType_);
    } else {
      return Asn1Integer.getPossibleFirstTags();
    }
  }
  ...
  /**
   * Creates a new gloAlmnAType_ from encoded stream.
   */
  public static gloAlmnAType_ fromPerUnaligned(byte[] encodedBytes) {
    gloAlmnAType_ result = new gloAlmnAType_();
    result.decodePerUnaligned(new BitStreamReader(encodedBytes));
    return result;
  }
   ...
   * Creates a new gloAlmnAType_ from encoded stream.
   */
  public static gloAlmnAType_ fromPerAligned(byte[] encodedBytes) {
    gloAlmnAType_ result = new gloAlmnAType_();
    result.decodePerAligned(new BitStreamReader(encodedBytes));
    return result;
  }
  ...
  public String toIndentedString(String indent) {
    return "gloAlmnAType_ = " + getInteger() + ";\n";
  }
}
