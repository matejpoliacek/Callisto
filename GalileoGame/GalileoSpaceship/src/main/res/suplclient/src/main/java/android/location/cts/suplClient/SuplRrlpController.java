...
public class SuplRrlpController {
  ...
  public GpsNavMessageProto generateNavMessage(long latE7, long lngE7)
	...
	// PC: SET capabilities in SUPL START must be modified to include GANSS Pos methods for Galileo
    ...
    // Receive a SUPL POS message from the server containing all the assistance data requested
  ...
  // PC this function to be modified for Galileo too at least - it transform the decoded message 
  // from the positioning payload of the SUPL POS message into internal class Proto
